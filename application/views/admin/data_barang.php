...
<div class="container-fluid">
	...
	<table class="table table-bordered">
		<tr style="background-color:#008B8B;" class="text-white">
			<th>No</th>
			<th>Nama Barang</th>
			<th>Keterangan</th>
			<th>Kategori</th>
		...
		<tr style="background-color:#DCDCDC;"> 
			<td><?php echo $no++; ?></td>
			<td><?php echo ucwords($brg->nama_brg) ?></td>
			<td><?php echo ucwords($brg->keterangan) ?></td>
			<td><?php echo ucwords($brg->kategori) ?></td>
